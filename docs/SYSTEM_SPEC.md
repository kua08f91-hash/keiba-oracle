...
### 券種別オッズ帯 (D2 Strategy — expanded candidates)

| 券種 | オッズ下限 | オッズ上限 | 最大点数/R | 備考 |
|------|----------|----------|-----------|------|
| 馬単 (umatan) | 50倍 | 300倍 | 2点 | Top7で候補数+110% |
| 馬連 (umaren) | 15倍 | 30倍 | 2点 | 下限を20→15に拡大 |
| ワイド (wide) | 10倍 | 30倍 | 2点 | |

※ AI候補馬: Top-7 (従来Top-5から拡大)
※ 馬単50x+の候補: 5C2=10通り → 7C2=21通り (+110%)
